...
import dev.jchejarla.springbatch.clustering.autoconfigure.BatchClusterProperties.HostIdentifier;
import dev.jchejarla.springbatch.clustering.mgmt.ClusterNode;
import dev.jchejarla.springbatch.clustering.mgmt.NodeLoad;
...
public class DatabaseBackedClusterService {
    ...
    public int updateNodeHeartbeat() {
        Object[] params = new Object[]{new Date(), NodeLoad.INST.getCurrentLoad().longValue(), batchClusterProperties.getNodeId()};
