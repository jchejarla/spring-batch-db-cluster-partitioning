...
public class SimpleAdditionTestJobConfig {
    ...
    @Bean
    public StepExecutionAggregator aggregator(JobRepository jobRepository, JobExplorer jobExplorer) {
        simpleSumAggregatorCallback = new SimpleSumAggregatorCallback();
        ClusterAwareAggregator clusterAwareAggregator = new ClusterAwareAggregator(jobRepository, simpleSumAggregatorCallback);
