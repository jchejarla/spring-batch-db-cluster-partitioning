...
import io.github.jchejarla.springbatch.clustering.api.ClusterAwareAggregatorCallback;
import io.github.jchejarla.springbatch.clustering.api.ClusterAwareAggregator;
...
public class SimpleJobConfig {
    ...
    public StepExecutionAggregator aggregator(JobRepository jobRepository) {
        ...
        ClusterAwareAggregator clusterAwareAggregator = new ClusterAwareAggregator(jobRepository, sumAggregatorCallback);
